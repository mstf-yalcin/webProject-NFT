...
<html lang="en">
<head>
    <title>Profile || Nuron - NFT Marketplace Template</title>
 ...
 @include('include/header')
  ...
  @else
  <div  class="rn-author-bg-area bg_image--9 bg_image ptb--150"  style='background-image: url({{asset(@Auth::user()->cover)}}'>
  @endif
                    ...
                    <div class="author-wrapper">
                        <div class="author-inner">
                            <div class="user-thumbnail">
                                ...
                                <a href="javascript:void()"><img src="assets/images/icons/boy-avater.png" style="width:140px;height:140px" alt="Images"></a>
                                @elseif(@Auth::user()->pp==null && @Auth::user()->gender==0)
                                <a href="javascript:void()"><img src="assets/images/icons/girl-avater.png"style="width:140px;height:140px" alt="Images"></a>
                                @else
                                <a href="javascript:void()"><img src="{{asset(@Auth::user()->pp)}}" style="width:140px;height:140px"   alt="Images"></a>
                                @endif
                            </div>
                            <div class="rn-author-info-content">
                               ...
                               <span> {{@Auth::user()->bio}} </span>
                                ...
                                <div class="author-button-area">
                                    ...
                                    <a href="{{route('bids')}}" class="btn at-follw follow-button edit-btn">
                                    ...
                                    <a href="{{route('editProfile')}}" class="btn at-follw follow-button edit-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
                    ...
                    <div class="tab-wrapper-one">
                        <nav class="tab-button-one">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-bid-tab" data-bs-toggle="tab" data-bs-target="#nav-bid" type="button" role="tab" aria-controls="nav-bid" aria-selected="false">Your Bids</button>
                            </div>
                        </nav>
                    </div>
                </div>
           ...
           {{-- On Sale --}}
            <div class="tab-content rn-bid-content" id="nav-tabContent">
                            ...
                            <div class="product-share-wrapper">
                                ...
                                <div class="share-btn share-btn-activation dropdown">
                                    ...
                                    <div class="share-btn-setting dropdown-menu dropdown-menu-end">
                                        ...
                                        {{-- <button type="button" class="btn-setting-text report-text" data-bs-toggle="modal{{$nft->nftId}}" data-bs-target="#reportModal{{$nft->nftId}}">
                                            Update
                                        </button> --}}
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="rn-not-found-wrapper">
                                        ...
                                        <p>You don't have any NFT for sale!</p>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="rn-not-found-wrapper">
                                        <h3 class="title">No items to display</h3>
                                        <p>You don't have any created NFT!</p>
                ...
                <div class="tab-pane row g-5 d-flex fade" id="nav-bid" role="tabpanel" aria-labelledby="nav-bid-tab">
                    <!-- start single product -->
                ...
                <div class="modal-body">
                    <ul class="social-share-default">
                        <li><a href="http://github.com/mstf-ylcn" target="_blank"><span class="icon"><i data-feather="github"></i></span><span class="text">github</span></a></li>
                                        ...
                                        <li><a href="https://www.linkedin.com/in/mstf-ylcn/" target="_blank"><span class="icon"><i data-feather="linkedin"></i></span><span class="text">linkedin</span></a></li>
                                        <li><a href="https://www.instagram.com/mustafayalcin.jpg" target="_blank"><span class="icon"><i data-feather="instagram"></i></span><span class="text">instagram</span></a></li>
                                        <li><a href="javascript:void(0)" onclick="copyUser('{{Auth::user()->userId}}')"><span class="icon"><i data-feather="copy"></i></span><span class="text">Copy</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
