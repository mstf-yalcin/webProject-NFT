...
<head>
    <title>Admin Update Nft || Nuron - NFT Marketplace Template</title>
    ...
    <form onsubmit="load()" action="{{route('adminNftUpdate',$nft->nftId)}}" method="post" enctype="multipart/form-data">
        @csrf
    <div class="create-area rn-section-gapTop">
        <div class="container">
            <div class="row g-5">
                ...
                <div  class="col-lg-7">
                    @if($nft->sellStatus==-1)
                    <div class="alert alert-danger" style="background-color:#ff0000!important;color:white;font-size:22px;border:0;text-align:center" role="alert">
                    ...
                    <div class="form-wrapper-one">
                            ...
                            <div class="col-md-12">
                                <div class="input-box pb--20">
                                    ...
                                    <input id="name" name="productName" value="{{$nft->name}}" d required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="input-box pb--20">
                                    ...
                                    <textarea name="discription" id="Discription" rows="3"  d  required>{{$nft->discription}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 createPageInput">
                                <div class="input-box pb--20">
                                    ...
                                    <input name="size" id="Size" min="1" max="10" required d  value="{{$nft->size}}" >
                                    <!-- max="999" -->
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 createPageInput">
                                <div class="input-box pb--20">
                                    ...
                                    <input name="royality" id="Royality" d    min="0" max="50" required value="{{$nft->royality}}" >
                                </div>
                            </div>
                            ...
                            <div class="half-wid currency">
                                <div class="col-md-12">
                                    <div class="input-box pb--10">
                                        ...
                                        <input name="property" id="Propertie"  d  onkeydown="return /[a-z ]/i.test(event.key)"  type="text" required value="{{$nft->property}}">
                                    </div> 
                                </div>
                            </div>
                            <div    class="half-wid currency">
                        ...
                        <div style="width: 30%;margin-top:15px;float: right;margin-bottom:15px "  >
                            <div class="input-box" style="background: #212e48;border-radius:10px">
                                @if($nft->sellStatus==-1)
                                <button  onclick="recoverItem('{{$nft->nftId}}')" type="button" style="width: 100%;" class="btn btn-outline-success" >Recover Item</button>
                                @else
    ...
    function recoverItem(nftId)
    {
        ...
        Swal.fire({
         ...
         reverseButtons: true
            ...
            method: "post",
            type: "post",
            url: '{{route('adminRecoverNft')}}',
            data: {'nftId':nftId},
            success: function (response) {
                Swal.fire(
                     'Recover!',
                    'NFT item has been recoverd.',
                    'success'
                 ).then(function() {
                    // location.href = "/";
                    location.reload();
