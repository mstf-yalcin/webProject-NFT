...
<head>
    ...
    <title>Maintanance || Nuron - NFT Marketplace Template</title>
    ...
    <div class="bg_image--1 bg_image maintanance-heignt" data-black-overlay="7">
        <div class="rn-comeing-soon-area ">
            <div class="container-fluid pt--40 pb--35 maintanance-plr text-center">
                <div class="logo">
                    <a href="{{route('index')}}"><img src="assets/images/logo/logo-white.png" alt="Nft-Marketplace"></a>
                </div>
                <div class="maintanance-inner">
                    <div class="wrapper">
                        ...
                        <a href="{{route('support')}}" class="btn btn-primary btn-large mt--30">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
