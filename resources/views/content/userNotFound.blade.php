...
<head>
    ...
    <title>404 User || Nuron - NFT Marketplace Template</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="rn-not-found-wrapper">
                        ...
                        <h3 class="title">User not found!</h3>
                        <p>The page you are looking for not available.</p>
                        <a href="{{route('index')}}" class="btn btn-primary btn-large">Go Back To Home</a>
                    </div>
                </div>
            </div>
        </div>
